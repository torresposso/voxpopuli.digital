...
if (! function_exists('wp_get_post_categories')) {
    function wp_get_post_categories(int $post_id = 0, array $args = []) { global $wp_post_categories; return $wp_post_categories ?? []; }
}
...
if (! function_exists('get_post_field')) {
    function get_post_field(string $field, $post = null, string $context = 'display') { global $wp_post_content_map; return $wp_post_content_map[$post] ?? ''; }
}
...
if (! function_exists('get_post_thumbnail_id')) {
    function get_post_thumbnail_id($post = null) { global $wp_post_thumbnail_id; return $wp_post_thumbnail_id ?? 0; }
}
if (! function_exists('get_post_meta')) {
    function get_post_meta($post_id, string $key = '', bool $single = false) { global $wp_post_meta_map; return $wp_post_meta_map[$post_id][$key] ?? ''; }
}
if (! function_exists('get_the_date')) {
    function get_the_date(string $format = '', $post = null) { global $wp_the_date; return $wp_the_date ?? ''; }
}
...
if (! function_exists('is_archive')) {
    function is_archive() { global $wp_is_archive; return $wp_is_archive ?? false; }
}
if (! function_exists('get_the_archive_title')) {
    function get_the_archive_title() { global $wp_archive_title; return $wp_archive_title ?? ''; }
}
if (! function_exists('is_search')) {
    function is_search() { global $wp_is_search; return $wp_is_search ?? false; }
}
if (! function_exists('get_search_query')) {
    function get_search_query($escaped = true) { global $wp_search_query; return $wp_search_query ?? ''; }
}
if (! function_exists('is_404')) {
    function is_404() { global $wp_is_404; return $wp_is_404 ?? false; }
}
if (! function_exists('wp_link_pages')) {
    function wp_link_pages($args = '') { return ''; }
}
if (! function_exists('wp_get_attachment_image_src')) {
    function wp_get_attachment_image_src($attachment_id, $size = 'thumbnail', $icon = false) { global $wp_attachment_image_src; return $wp_attachment_image_src ?? false; }
}
if (! function_exists('wp_get_attachment_caption')) {
    function wp_get_attachment_caption($post_id = 0) { global $wp_attachment_caption; return $wp_attachment_caption ?? ''; }
}
if (! function_exists('get_the_ID')) {
    function get_the_ID() { global $wp_the_id; return $wp_the_id ?? 0; }
}
if (! function_exists('_n')) {
    function _n($single, $plural, $number, $domain = 'default') { return $number == 1 ? $single : $plural; }
}
if (! function_exists('get_the_category')) {
    function get_the_category($id = false) { global $wp_the_category; return $wp_the_category ?? []; }
}
if (! function_exists('get_term')) {
    function get_term($term, $taxonomy = '', $output = 'OBJECT', $filter = 'raw') { global $wp_term; return $wp_term ?? null; }
}
if (! function_exists('is_wp_error')) {
    function is_wp_error($thing) { return false; }
}
if (! function_exists('get_category_link')) {
    function get_category_link($category) { return 'link-to-cat-'.$category; }
}
if (! function_exists('wp_get_attachment_image_url')) {
    function wp_get_attachment_image_url($attachment_id, $size = 'thumbnail', $icon = false) { return ''; }
}
if (! function_exists('get_the_excerpt')) {
    function get_the_excerpt($post = null) { global $wp_the_excerpt; return $wp_the_excerpt ?? ''; }
}
if (! function_exists('wp_reset_postdata')) {
    function wp_reset_postdata() {}
}
if (! function_exists('sprintf')) {
    function sprintf($format, ...$args) { return \sprintf($format, ...$args); }
}
...
if (! class_exists('WPSEO_Primary_Term')) {
    class WPSEO_Primary_Term {
        ...
        public function get_primary_term() { global $wp_yoast_primary_term; return $wp_yoast_primary_term; }
    }
}
