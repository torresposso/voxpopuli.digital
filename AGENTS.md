...
This project is indexed by GitNexus as **voxpopuli.digital** (614 symbols, 1043 relationships, 17 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/voxpopuli.digital/context` | Codebase overview, check index freshness |
| `gitnexus://repo/voxpopuli.digital/clusters` | All functional areas |
| `gitnexus://repo/voxpopuli.digital/processes` | All execution flows |
| `gitnexus://repo/voxpopuli.digital/process/{name}` | Step-by-step execution trace |
