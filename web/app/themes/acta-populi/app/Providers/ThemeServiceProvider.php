...
class ThemeServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        add_action('after_setup_theme', function () {
            ...
            register_nav_menus([
                'primary_navigation' => __('Primary Navigation', 'acta-populi'),
            ]);
        ...
        add_action('widgets_init', function () {
            ...
            register_sidebar([
                'name' => __('Primary', 'acta-populi'),
                'id' => 'sidebar-primary',
            ] + $config);

            register_sidebar([
                'name' => __('Footer', 'acta-populi'),
                'id' => 'sidebar-footer',
            ] + $config);
        });
        ...
        $invalidateCache = function () {
            ...
            \Illuminate\Support\Facades\Cache::forget('acta-populi_homepage_sections_ids');
        };
