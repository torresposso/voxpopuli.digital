...
class Newsletter extends Block
{
	...
	public static function get_default_props() 
	{
		$props = [
			...
			'icon'        => '',
			'message'     => 'Recibe las últimas investigaciones y noticias de Vox Populi directamente en tu correo.',
			'submit_text' => 'Suscribirse',
			'submit_url'  => '',
			'disclaimer'  => 'Al registrarte, aceptas nuestros términos y políticas de privacidad.',
			'checkbox'    => 1,
		];
