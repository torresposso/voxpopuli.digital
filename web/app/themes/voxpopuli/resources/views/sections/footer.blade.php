...
<footer class="bg-primary text-primary-content">
  ...
  <div class="max-w-7xl mx-auto px-4 py-12 lg:py-16">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
      ...
      <div>
        <a href="{{ home_url('/') }}" class="inline-block no-underline group focus-visible:outline-white focus-visible:outline-2 focus-visible:outline-offset-4 rounded-sm">
          ...
          <span class="font-sans font-normal text-[0.6875rem] tracking-[0.15em] text-base-100/40 uppercase">digital</span>
        </a>
        <p class="font-serif text-sm text-base-100/60 leading-relaxed mt-5 max-w-xs">
      ...
      <div>
        ...
        <ul class="space-y-2.5">
          ...
          @foreach ($footerMenuItems as $item)
            ...
            <li>
              <a href="{{ $item->url }}"
                 class="font-sans text-sm text-base-100/70 hover:text-accent transition-colors duration-200 no-underline">
                {{ $item->title }}
              </a>
            </li>
        ...
        @if ($footerShown === 0)
          <p class="font-serif text-sm text-base-100/40 italic">
      ...
      <div>
        ...
        <p class="font-serif text-sm text-base-100/60 leading-relaxed max-w-xs">
          {{ __('Cartagena de Indias, Colombia', 'voxpopuli') }}
        </p>

        {{-- Social icons — mismos que el header, invertidos para fondo oscuro --}}
        <div class="flex items-center gap-4 mt-6">
          <a href="#" class="text-base-100/50 hover:text-accent transition-colors duration-200" aria-label="X (Twitter)">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
            </svg>
          </a>
          <a href="#" class="text-base-100/50 hover:text-accent transition-colors duration-200" aria-label="Instagram">
          ...
          <a href="#" class="text-base-100/50 hover:text-accent transition-colors duration-200" aria-label="YouTube">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-center gap-2">
      <p class="font-sans text-[0.6875rem] text-base-100/40">
        &copy; {{ date('Y') }} Vox Populi Digital.
        {{ __('Todos los derechos reservados.', 'voxpopuli') }}
      </p>
      <p class="font-sans text-[0.6875rem] text-base-100/30">
