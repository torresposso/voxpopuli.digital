...
class Comments extends Composer
{
    ...
    {
        // ⚡ Bolt: Cache get_comments_number() locally to prevent redundant function calls/queries
        ...
        return sprintf(
            ...
            (int) $comments_number === 1 ? _x('One', 'comments title', 'voxpopuli') : number_format_i18n((int) $comments_number),
            get_the_title(),
        );
    }
